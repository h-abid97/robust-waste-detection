...
# Load from your finetuned checkpoint
...
train_dataloader = dict(
   ...
   batch_sampler=dict(type='RatioBalancedBatchSampler', ratio_per_dataset=[0.33, 0.67], drop_last=False),
   batch_size=8,
   num_workers=2,
...
work_dir = 'experiments/swin-t_zerowaste_semi-supervised'